...
//check whether password matches 
	...
	$sql=mysqli_query($dbc,"SELECT staffid FROM registration WHERE staffid='$staffid'");

if(mysqli_num_rows($sql)==0){
	//Inserting to database

	
	$insertsql=mysqli_query($dbc,"INSERT INTO registration (firstname, surname, lastname, staffid, idno, department, supervisor, dateofbirth, telephone, email, gender, level, password) VALUES('".$firstname."','".$surname."','".$lastname."','".$staffid."','".$idno."','".$department."','".$supervisor."','".$dateofbirth."','".$telephone."','".$email."','".$gender."','".$level."','".$pass."')"); 
