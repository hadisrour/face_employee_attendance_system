...
if(isset($_POST['login'])){
	...
	if($level=="Employee"){
		$sql = mysqli_query($dbc,"SELECT * FROM registration WHERE staffid='$staffid' AND password ='$password'");
		...
		$sql2 = mysqli_query($dbc,"SELECT * FROM registration WHERE staffid='$staffid' AND password ='$password' AND level='$level'");
