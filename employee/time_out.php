...
if(isset($staffid) && isset($time_out) && isset($date)){

if(!empty($staffid) && !empty($time_out) && !empty($date)){

	$insertsql=mysqli_query($dbc,"INSERT INTO time_out (staffid, time_out, date) 
		VALUES('".$staffid."','".$time_out."','".$date."')"); 
